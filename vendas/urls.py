...
urlpatterns = [
    ...
    # 🔥 NOVA VENDA (ADMIN)
    path('vendas/nova-venda/', views_principais.nova_venda, name='nova_venda'),
    ...
    path('retomar-pagamento/<int:pedido_id>/', views_principais.retomar_pagamento, name='retomar_pagamento'),
